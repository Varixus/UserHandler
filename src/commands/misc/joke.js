...
module.exports = {
    ...
    callback: async (client, interaction) => {
        try {
            ...
            const randomNumber = Math.floor(Math.random() * jokeStorage.length);
            ...
            console.error(`ERROR (joke.js): ${error}`);
            await interaction.reply('Sorry, I couldn\'t fetch a joke for you right now.');
        }
    }
};